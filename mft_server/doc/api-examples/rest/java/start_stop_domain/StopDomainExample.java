...
/**
 * This example demonstrates how to stop a domain using the server API.
 */
public class StopDomainExample {
    ...
    private static final String STOP_DOMAIN_URI_TEMPLATE = "/rest/management/domains/%s/stop";
    ...
    public static void main(String[] args)
            throws Exception {
        showExampleTitle();
        StopDomainExample example = createExample();
        example.execute();
    }
    ...
    private static void showExampleTitle() {
        System.out.println("This example demonstrates how to stop a domain using the server API.");
        System.out.println();
    }
     ...
     * @throws Exception if an error occurs
     */
    private static StopDomainExample createExample()
            throws Exception {
        ...
        return new StopDomainExample(host, port, username, password, domainName);
    }
     ...
     */
    public StopDomainExample(String host, int port, String username, String password, String domainName) {
        this.host = host;
        this.port = port;
    ...
    private void stopDomain()
            throws Exception {
        URL url = new URI(SCHEME, null, this.host, this.port, String.format(STOP_DOMAIN_URI_TEMPLATE, this.domainName), null, null).toURL();
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
