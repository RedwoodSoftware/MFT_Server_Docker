...
/**
 * This example demonstrates how to download a file using the server REST API.
 */
public class GetFileExample {
    ...
    private static final String DOWNLOAD_URI = "/rest/files";
    private static final String DOWNLOAD_QUERY_STRING_TEMPLATE = "path=%s&offset=0";
    ...
    public static void main(String[] arguments)
            throws Exception {
        showExampleTitle();
        GetFileExample example = createExample();
        example.execute();
    }
    ...
    private static void showExampleTitle() {
        System.out.println("This example demonstrates how to download a file using the server REST API.");
        System.out.println();
    }
     ...
     * @throws Exception if an error occurs
     */
    private static GetFileExample createExample()
            throws Exception {
        ...
        String remotePath = getParameter("Enter remote file path: ");
        String localPath = getParameter("Enter local file path: ");

        return new GetFileExample(host, port, username, password, domainName, remotePath, localPath);
    }
     ...
     */
    public GetFileExample(String host,
                          int port,
                          String username,
                          String password,
                          String domainName,
    ...
    private void downloadFile()
            throws Exception {
        URL url = new URI(SCHEME, null, this.host, this.port, DOWNLOAD_URI, String.format(DOWNLOAD_QUERY_STRING_TEMPLATE, this.remoteFilePath), null).toURL();
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
     ...
     * @throws Exception if an error occurs
     */
    private void downloadFile(InputStream in)
            throws Exception {
        try (OutputStream out = new FileOutputStream(this.localFilePath)) {
