<div id="domain-server-keys-fields">
        ...
        <div class="viewpane-toolbar inline">
            ...
            <#if permissions.domainKeystoreControlAllowed>
                <@form.button name="generate" class="m-btn m-btn-small"><@i18n.message key="KeyManager.button.generate" /><span class="m-btn-downarrow"></span>
                    <div role="menu" aria-label="generate-menu" class="hidden">
            ...
            <div class="toolbar-management">
                ...
                <@form.button name="crl" class="m-btn m-btn-small"><@i18n.message key="KeyManager.button.revocationList" /><span class="m-btn-downarrow"></span>
                    <div role="menu" aria-label="crl-menu" class="hidden">
                        <#if permissions.domainKeystoreControlAllowed>
                            <div role="menuitem" data-options="id:'menu-crl-generate'"><@i18n.message "KeyManager.menu.generateCrl"/></div>
                        </#if>
                        <div role="menuitem" data-options="id:'menu-crl-verify'"><@i18n.message "KeyManager.menu.verifyCrl"/></div>
                    </div>
                </@>
                <#if permissions.domainKeystoreControlAllowed><@form.button name="revoke"><@i18n.message "KeyManager.button.revoke"/></@></#if>
                <#if permissions.domainKeystoreControlAllowed><@form.button name="delete"><@i18n.message "KeyManager.button.delete"/></@></#if>
            </div>
        </div>
    </div>
</div>