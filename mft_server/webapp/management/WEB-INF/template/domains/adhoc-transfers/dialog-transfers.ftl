<@form.dialog id="d-adhoctransfer-extend" title=i18n.text('AdHocTransfers.ExtendDialog.title')>
    <fieldset name="adhoctransferextendfields" role="presentation">
        <div><@i18n.message key="AdHocTransfers.ExtendDialog.message" /></div><br/>
        <div class="inline"><@form.text name="date" maxlength=50 required=true><@i18n.message key="AdHocTransfers.label.date" /></@></div>
    </fieldset>
</@form.dialog>
...
<@form.dialog id="d-adhoctransfer-view" title=i18n.text('AdHocTransfers.ViewDialog.title')>
        <div id="adhoctransferemailfields">
            <div data-options="region:'north',border:false" style="min-height:200px;padding:10px">
                <fieldset class="pane">
                    <dl class="group">
                        <dt><@i18n.message key="AdHocTransfers.label.user" /></dt><dd><span aria-label="user"></span></dd>
            ...
            <div data-options="region:'center',border:false" style="padding:1em">
                <@form.datagrid name="transferobjects" height="" columns=["name", "path", "clientIp", "downloads", "expires", "deleteAfter", "type", "status"];col><@i18n.message key="AdHocTransfers.column.${col}" /></@>
            </div>
