...
d.remove();
},_parseValueSafe:function(s){
    function _logError(m) { console && console.warn("Error parsing value '" + m + "'."); }
    if (typeof s === "string") {
        if (s === "") {
            return s;
        } else if (s.startsWith("[") && s.endsWith("]")) {
            s = s.substring(1, s.length - 1);
            var re = /(?:^|,\s*)("(?<quoted>[^"]*)"|'(?<quoted>[^']*)'|\{(?:[^\}]*)\}|\[(?:[^\]]*)\]|[^,]*)/g;
            var items = [], m = [];
            while ((m = re.exec(s)) !== null) {
                var item = m.groups && m.groups.quoted != undefined ? m.groups.quoted : m[1] ;
                items.push($.parser._parseValueSafe(item) || item);
            }
            return items;
        } else if (s.startsWith("{")) {
            try {
                return JSON.parse(s.replaceAll("'",'"').replaceAll(/([{,]\s*)(([a-zA-Z0-9_]+)\:)/g, '$1"$3":'));
            } catch (e) { _logError(e); }
...
a[0].onclick=typeof btn.handler==="function"?btn.handler:function(){};
...
var t=$(_d1);
return $.extend({},$.parser.parseOptions(_d1,[{total:"number",pageSize:"number",pageNumber:"number",links:"number"},{loading:"boolean",showPageList:"boolean",showPageInfo:"boolean",showRefresh:"boolean"}]),{pageList:$.parser._parseValueSafe(t.attr("pageList"))});
};
...
_23c(tool,t.iconCls,typeof t.handler==="function"?t.handler:function(){});
});
}else{
...
tool[0].onclick=typeof btn.handler==="function"?btn.handler:function(){};
...
var td=$("<td></td>").appendTo(tr);
var tool=$("<a href=\"javascript:;\"></a>").appendTo(td);
tool[0].onclick=typeof opts.tools[i].handler==="function"?opts.tools[i].handler:function(){};
...
}else if(typeof _44c.onclick=="function"){
item[0].onclick=_44c.onclick;
}
}
if(_44c.disabled){
...
if(rule&&_5a8){
var _5aa=_5a7||opts.validParams||$.parser._parseValueSafe(_5a9[2]);
...
var t=$(_68a);
return $.extend({},$.fn.textbox.parseOptions(_68a),$.parser.parseOptions(_68a,["menu",{duration:"number"}]),{searcher:$.parser._parseValueSafe(t.attr("searcher"))});
};
...
var th=$(this);
var col=$.extend({},$.parser.parseOptions(this,["id","field","align","halign","order","width",{sortable:"boolean",checkbox:"boolean",resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),hformatter:$.parser._parseValueSafe(th.attr("hformatter")),hstyler:$.parser._parseValueSafe(th.attr("hstyler")),formatter:$.parser._parseValueSafe(th.attr("formatter")),styler:$.parser._parseValueSafe(th.attr("styler")),sorter:$.parser._parseValueSafe(th.attr("sorter"))});
...
if(s.substr(0,1)=="{"){
col.editor=$.parser._parseValueSafe(s);
}else{
col.editor=s;
}
}
...
var t=$(_947);
return $.extend({},$.fn.panel.parseOptions(_947),$.parser.parseOptions(_947,["url","toolbar","idField","sortName","sortOrder","pagePosition","resizeHandle",{sharedStyleSheet:"boolean",fitColumns:"boolean",autoRowHeight:"boolean",striped:"boolean",nowrap:"boolean"},{rownumbers:"boolean",singleSelect:"boolean",ctrlSelect:"boolean",checkOnSelect:"boolean",selectOnCheck:"boolean"},{pagination:"boolean",pageSize:"number",pageNumber:"number"},{multiSort:"boolean",remoteSort:"boolean",showHeader:"boolean",showFooter:"boolean"},{scrollbarSize:"number",scrollOnSelect:"boolean"}]),{pageList:$.parser._parseValueSafe(t.attr("pageList")),loadMsg:(t.attr("loadMsg")!=undefined?t.attr("loadMsg"):undefined),rowStyler:$.parser._parseValueSafe(t.attr("rowStyler"))});
};
...
var t=$(_d96);
return $.extend({},$.parser.parseOptions(_d96,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:$.parser._parseValueSafe(t.attr("rule"))});
};
