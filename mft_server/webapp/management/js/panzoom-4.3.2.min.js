...
(function ($) {
    ...
    $.fn.panzoom = function (options) {
        if (typeof options === "string") {
            ...
            var result = [];
            this.each(function () {
                var instance = $.data(this, "panzoom");
                var m, r;
                if (!instance) {
                    result.push(undefined);
                } else if (method.charAt(0) !== "_" && typeof (m = instance[method]) === "function" && (r = m.apply(instance, args)) !== undefined) {
                    result.push(r);
                }
            });
            return result.length ? (result.length == 1 ? result[0] : result) : this;
        }
        return this.each(function () { $.data(this, "panzoom", new window.Panzoom(this, options)); });
    };
}(jQuery));