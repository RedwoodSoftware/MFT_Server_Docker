...
(function() {
    ...
    FLOWPAPER.initFrontPagePreview = function initFrontPagePreview(viewerid,args,IMGFiles){
        ...
        jQuery(img).bind('load',function(){
            jQuery(document.body).append(
                ...
                "<form class='flowpaper_htmldialog' method='POST' autocomplete='off' style='display:none;top:100px;margin:"+((jQuery(window).height()>350)?"50px auto":"0px auto")+";padding-bottom:0px;'>"+
    ...
    FLOWPAPER.initLoginForm = function initLoginForm(IMGFiles,animate,callback){
        ...
        jQuery(img).bind('load',function(){
            jQuery(document.body).append(
                "<div id='loginForm'>"+
                "<form class='flowpaper_htmldialog' method='POST' autocomplete='off' style='display:none;top:100px;margin:"+((jQuery(window).height()>500)?"50px auto":"0px auto")+"'>"+
