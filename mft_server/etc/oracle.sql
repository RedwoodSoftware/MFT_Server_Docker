...
(
    ...
    certificateBeginDate    NUMBER(19)   NOT NULL,
    certificateEndDate      NUMBER(19)   NOT NULL,
...
(
    ...
    keyAlgorithm   VARCHAR(50)  NOT NULL,
    keySize        INTEGER      NOT NULL,
    expirationDate NUMBER(19) DEFAULT NULL,
...
(
    ...
    messageDate    NUMBER(19)   NOT NULL,
...
(
    id             VARCHAR(255) NOT NULL,
    expirationDate NUMBER(19)   NOT NULL,
    data           BLOB         NOT NULL,
    PRIMARY KEY (id)
);
